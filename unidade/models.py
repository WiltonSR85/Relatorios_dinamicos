...
class Unidade(models.Model):
    ...
    fabricante = models.CharField(verbose_name="Fabricante", max_length=255,)
    modelo = models.CharField(verbose_name="Modelo", max_length=255)
    ...
    placa = models.CharField(verbose_name="Placa", max_length=255, unique=True, help_text="Ex: XXX-9X99")
